    ...
    return (
        <section className='main__members__item'>
            ...
            <div className='main__members__item__statisctic'>
                <p className='main__members__item__statisctic__info'>Solved: <span className='main__members__item__statisctic__info__solved'>12</span></p>
                <p className='main__members__item__statisctic__info'>Not in time: <span className="main__members__item__statisctic__info__notime">2</span></p>
            </div>
        </section>
